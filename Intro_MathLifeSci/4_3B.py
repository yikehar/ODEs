...
for T in range(Tmax - 1):
    ...
    # Calc. at the corners
    X, Y = 0, 0
    E[Y, X, T + 1] = dt * (d * (E[Y, X + 1, T] + E[Y + 1, X, T] - 2 * E[Y, X, T])) / dx/dx + E[Y, X, T]
...
images.pop(0).save(path + "4_3B.gif" ,save_all = True, append_images = images, duration = 100, optimize = False, loop = 0)