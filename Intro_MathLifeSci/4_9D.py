...
4.9B
Proneural wave
Four-variable model, Notch mutant
...
images.pop(0).save(path + "4_9D.gif" ,save_all = True, append_images = images, duration = 10, optimize = False, loop = 0)
